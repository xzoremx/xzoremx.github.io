  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1>Consulta del Historial de Almacenamiento de Muebles y Enseres</h1>
                </div>
...
if ($stmt) {
    ...
    $stmt->bind_result($ID_ME, $fecha, $ID_Cliente, $Nombre_de_Cliente, $Descripcion, $Cantidad, $Ubicacion_en_Almacen, $fecha_limite, $fechasistema);
}
?>
<style>
    table {
                        ...
                        if ($total_registros > 0) { //Existen datos
                            while ($stmt->fetch()) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($Nombre_de_Cliente); ?></td>
