  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1>Gestión del Historial de Devoluciones de Muebles y Enseres</h1>
                </div>
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <form action="LOG-008.php" method="post">
...
$sql = "SELECT * FROM devolucion_almacen";
if (!empty($fecha)) {
    $sql .= " WHERE fecha = ?";
}
...
if ($stmt) {
    ...
    $stmt->bind_result($ID_Devolucion, $fecha, $ID_Cliente, $Nombre_del_Cliente, $Descripcion, $Cantidad, $ID_ME, $Estado, $fechasistema);
}
?>
        ...
        <tbody>
            ...
            if ($total_registros > 0) { //Existen datos
                while ($stmt->fetch()) {
                    ?>
                    <tr>
                        <td><?php echo htmlspecialchars($ID_Devolucion); ?></td>
                        ...
                        <td class="text-center">
                            ...
                            <a class="btn btn-info btn-sm" href="LOG-008-Editar.php?id=<?php echo $ID_Devolucion; ?>" onclick="return confirm('¿Seguro que deseas editar este registro?')">
                              <i class="fas fa-pencil-alt"></i>
                                Editar
                            </a>
                            <a class="btn btn-danger btn-sm" href="LOG-008-Eliminar.php?id=<?php echo $ID_Devolucion; ?>" onclick="return confirm('¿Seguro que deseas eliminar este registro?')">
