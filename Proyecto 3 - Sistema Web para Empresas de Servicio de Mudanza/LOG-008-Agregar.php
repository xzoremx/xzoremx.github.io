...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    // Procesa los datos del formulario de inserción y agrega la devolución del almacén a la base de datos
    $nuevos_datos = $_POST; // Obtén los nuevos datos del formulario

    // Realiza la inserción en la base de datos
    $sql = "INSERT INTO devolucion_almacen (fecha, ID_Cliente, `Nombre del Cliente`, Descripcion, Cantidad, ID_ME, Estado, fechasistema) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = $mysqli->prepare($sql);

    if ($stmt) {
        $stmt->bind_param("ssssssss", $nuevos_datos['fecha'], $nuevos_datos['ID_Cliente'], $nuevos_datos['Nombre_del_Cliente'], $nuevos_datos['Descripcion'], $nuevos_datos['Cantidad'], $nuevos_datos['ID_ME'], $nuevos_datos['Estado'], $nuevos_datos['fechasistema']);
        ...
        if ($stmt->execute()) {
            ...
            echo "Error al agregar la devolución del almacén: " . $stmt->error;
        }
    }
}
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1>Gestión del Historial de Devoluciones de Muebles</h1>
                </div>
...
<body>
    <h1>Agregar Nueva Devolución</h1>
    ...
    <!-- Aquí comienza el formulario para agregar una nueva devolución en la tabla existente -->
<form method="post">
    <table id="listado" class="table table-bordered table-striped">
        ...
        <tbody>
            <tr>
                ...
                <td><input type="text" name="ID_ME"></td>
                <td><input type="text" name="Estado"></td>
                <td><?php echo date("Y-m-d H:i:s"); ?></td>
                <td><input type="submit" value="Agregar Devolución de Almacén"></td>
            </tr>
        </tbody>
    </table>
</div>
