...
if(isset($_POST["correo"]) && isset($_POST["clave"]) ){
  $correo = $_POST["correo"];
  $clave = $_POST["clave"];
  $sql = "Select * From cliente Where correo='$correo' and clave = '$clave' and estado='A'";
  //echo("<br />".$sql);
  //exit(0);
  $result = dbQuery($sql);
  ...
  { $row = mysqli_fetch_array($result, MYSQLI_BOTH);   
    ...
    echo "window.location.href='PaginaPrincipalCliente.php';";
    echo "</script>";
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="PaginaPrincipalCliente.php" class="h1"><b>Mudanzas</b>TOP</a>
    </div>
    <div class="card-body">
